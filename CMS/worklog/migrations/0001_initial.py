    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_id', CMS.utils.ULIDField(editable=False, max_length=26, verbose_name='project ulid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(blank=True, max_length=500)),
                ('updated_by', models.CharField(blank=True, max_length=500)),
                ('internal_id', CMS.utils.ULIDField(editable=False, max_length=26, verbose_name='task type ulid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('internal_id', CMS.utils.ULIDField(editable=False, max_length=26, verbose_name='dsr ulid')),
